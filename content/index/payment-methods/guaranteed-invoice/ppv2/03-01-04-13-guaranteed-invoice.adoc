...
An _authorization_ reserves the specified amount from the account holder’s bank account for a later transfer. For Guaranteed Invoice, it also triggers a creditworthiness-check.
